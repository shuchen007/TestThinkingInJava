...
public class Test_sikai_service01 {
...
//    public static String PlatformUrl="http://10.89.2.102/ktwcf/ScyxKtService.svc/GetScyxUnit";
    ...
    public String requestSummary() {
        String x2 = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tem=\"http://tempuri.org/\">\n" +
                "   <soapenv:Header/>\n" +
                "   <soapenv:Body>\n" +
                "      <tem:GetScyxUnit/>\n" +
                "   </soapenv:Body>\n" +
...
//           HttpClient httpClient= HttpClients.createDefault();
            ...
            httppost.setHeader("SOAPAction","http://tempuri.org/IScyxKtService/GetScyxUnit");
...
//            jsonStr= getReponseJson(responseStr).replaceAll("\"null\"", "\"\"").replaceAll("null", "\"\"");
    ...
    public static void main(String[] strings){
        Test_sikai_service01 updateService = new Test_sikai_service01();
